...
{ public:
 ...
 while(p<=100)
     {
cout<<"Enter 1 for STUDNETS Part.\n";
cout<<"Enter 2 for STAFF Part.\n";
cin>>intro;
if(intro=="1")
 {   while(stdMenu<=10)
     {system("color 5B");
     system("cls");
  cout<<"Enter 1 to add a new Student and register him or her to courses.\n";
  cout<<"Enter 2 to edit a Student and his/her courses.\n";
  cout<<"Enter 3 to delete a student from the database.\n";
  cout<<"Enter 4 to print the Academic record of a the student.\n";
  cout<<"Enter any other key to go back.\n";
  cout<<"NB!: You can't edit, delete or print the records of a Student if you haven't";
  cout<<"\n entered any, else go for choose 1.\n";
  cin>>stdIntro;
  if(stdIntro=="1")
    {while (z<=10)
        {
